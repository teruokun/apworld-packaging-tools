...
"""CLI entry point for island command."""
...
def cli(ctx: Context, verbose: bool, directory: Optional[Path]) -> None:
    """Island package management tool.

    Build, validate, and publish Island packages for Archipelago.
...
from .commands import init, build, validate, publish, migrate, register, install
