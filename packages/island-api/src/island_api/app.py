...
def create_app(config: APIConfig | None = None) -> FastAPI:
    ...
    # Register API routes
    from .routes import download, packages, register, upload
    ...
    app.include_router(upload.router, prefix=config.api_prefix, tags=["management"])
    app.include_router(register.router, prefix=config.api_prefix, tags=["registration"])
