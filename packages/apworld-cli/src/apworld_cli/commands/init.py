...
"""Initialize a new APWorld project."""
...
@click.option(
    "--description",
    default="",
    help="Short description of the APWorld.",
)
@click.option(
    "--output-dir",
    "-o",
...
def init(
    ...
    echo_info(f"Creating APWorld project: {game}")
    ...
    template_dir = Path(__file__).parent.parent / "templates" / "apworld"
