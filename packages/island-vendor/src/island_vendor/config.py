...
class VendorConfig:
    ...
    Attributes:
        package_name: Name of the Island package (used for namespace)
    ...
    def from_pyproject(
        ...
        *,
        ...
        and [tool.island.vendor] section for vendor-specific configuration.
    ...
    def from_pyproject_dict(
        ...
        *,
        ...
        vendor_config = tool_island.get("vendor", {})
        ...
        # Get exclude list from tool.island.vendor.exclude
