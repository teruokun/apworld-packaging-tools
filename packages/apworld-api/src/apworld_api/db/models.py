...
"""SQLAlchemy database models for APWorld repository."""
...
class Package(Base):
    ...
    Represents a registered APWorld package in the repository.
    """
...
class Version(Base):
    ...
    Represents a specific version of an APWorld package.
    """
...
class Distribution(Base):
    """Distribution file model.

    Represents a downloadable distribution file (.apworld or .tar.gz).
    """
    ...
    uploaded_at: Mapped[datetime] = mapped_column(DateTime, default=_utc_now)
