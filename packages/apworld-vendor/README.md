...
APWorld packages need to be self-contained, bundling their dependencies to avoid conflicts with other APWorlds or Core Archipelago. This package provides:
...
```python
from apworld_vendor import VendorConfig
...
Reads from `[tool.apworld.vendor]` section:
...
```python
from apworld_vendor import VendorConfig, vendor_dependencies
...
```python
from apworld_vendor import vendor_dependencies, create_vendor_manifest
...
```python
from apworld_vendor import rewrite_file, CORE_AP_MODULES
...
```python
from apworld_vendor import rewrite_source, CORE_AP_MODULES
...
```python
from apworld_vendor import CORE_AP_MODULES
