...
This package provides utilities for working with APWorld manifests:
- JSON Schema definition for archipelago.json
- Validation with structured error reporting
- Transformation from pyproject.toml to archipelago.json

Example:
    >>> from apworld_manifest import validate_manifest, transform_pyproject
    >>>
