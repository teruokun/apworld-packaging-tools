...
from apworld_manifest.transformer import (
...
class TestTransformPyprojectDict:
    ...
    def test_game_from_tool_apworld(self):
        """Game name from tool.apworld takes precedence."""
        pyproject = {
            "project": {"name": "test-game"},
            "tool": {"apworld": {"game": "Custom Game Name"}},
        }
        manifest = transform_pyproject_dict(pyproject)
    ...
    def test_pure_python_false(self):
        ...
        pyproject = {
            "project": {"name": "test"},
            "tool": {"apworld": {"pure_python": False}},
        }
        manifest = transform_pyproject_dict(pyproject)
